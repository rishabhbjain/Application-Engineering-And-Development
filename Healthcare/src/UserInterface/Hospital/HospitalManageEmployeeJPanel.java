...
public class HospitalManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    public HospitalManageEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir) {
        ...
        //populateStaffComboBox(organization);
    ...
    private void initComponents() {
        ...
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 280, 126, -1));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 90, 20));

        ComboboxStaff.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(ComboboxStaff, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 230, -1, -1));
    }// </editor-fold>//GEN-END:initComponents

    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        
        Organization organization = (Organization) organizationEmpJComboBox.getSelectedItem();
       Staff staff = organization.getStaffDirectory().createStaff(String.valueOf(ComboboxStaff.getSelectedItem()));
       String name = nameJTextField.getText();
       // Staff staff = (Staff) ComboboxStaff.getSelectedItem();
       staff.getEmpdirectory().createEmployee(name);
       // Employee emp = organization.getEmployeeDirectory().createEmployee(name).setStaff(staff);
       // emp.setStaff(staff);
