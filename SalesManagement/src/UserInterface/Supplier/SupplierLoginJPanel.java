...
import UserInterface.Administrator.*;
...
public class SupplierLoginJPanel extends javax.swing.JPanel {
    ...
    public SupplierLoginJPanel(JPanel userProcessContainer, Business business) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String supUserName = "sup01";
        String supPassword = "1234";
        ...
        if(supUserName.equals(username)&&supPassword.equals(password)){
        ManageSuppliersJPanel ad = new ManageSuppliersJPanel(userProcessContainer,business);
        userProcessContainer.add("ManageSuppliers",ad);
