...
public class CreateSupplierJPanel extends javax.swing.JPanel {
    ...
    CreateSupplierJPanel(JPanel userProcessContainer, SupplierDirectory supplierdirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCreateSupplier.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        btnCreateSupplier.setText("Create");
        btnCreateSupplier.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCreateSupplierActionPerformed(evt);
            }
        });
        add(btnCreateSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, -1, -1));
    ...
    private void btnCreateSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateSupplierActionPerformed
        ...
        if(txtSupplierName.getText().equals("") || txtSupplierID.getText().equals("") || txtContactNumber.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,"Create successufully");
        }
