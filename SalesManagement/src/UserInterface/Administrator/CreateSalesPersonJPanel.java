...
public class CreateSalesPersonJPanel extends javax.swing.JPanel {
    ...
    CreateSalesPersonJPanel(JPanel userProcessContainer, EmployeeDirectory employeedirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCreateSalesPerson.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        ...
        add(btnCreateSalesPerson, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, -1, -1));
    ...
    private void btnCreateSalesPersonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateSalesPersonActionPerformed
        ...
        if(txtSalesPersonID.getText().equals("") || txtSalesPersonName.getText().equals("") || txtSalesPersonUserName.getText().equals("")|| txtSalesPersonPassword.getText().equals("")){
            ...
            SalesPerson salesperson = employeedirectory.addSalesPerson();
            ...
            JOptionPane.showMessageDialog(null,"SalesPerson created successufully");
        }
